          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li ><a href="<?php echo site_url('harga')?>"><i class="fa fa-circle-o"></i> Harga</a></li>
      	<li ><a href="<?php echo site_url('user')?>"><i class="fa fa-circle-o"></i> User</a></li>
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                 ...
                 <li> <a href="<?php echo site_url('barang/formRekap')?>"> <i class="fa fa-circle-o"></i> Laporan Barang</a></li>          
              </ul>
              
            </i>
			<?php endif; ?>	<?php if($CI->getStatus() == '2' || $CI->getStatus() == '1'): ?>
			<li class="treeview">
              <a href="<?php echo base_url("pod") ?>" target="_blank">
                <i class="fa fa-link"></i> <span>POD Kembali</span>
                <!-- <i class="fa fa-angle-left pull-right"></i> -->
              </a>
